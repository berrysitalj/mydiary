...
class DiariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create diary" do
    assert_difference('Diary.count') do
      post diaries_url, params: { diary: { content: @diary.content, theme: @diary.theme, title: @diary.title } }
    end
  ...
  test "should update diary" do
    patch diary_url(@diary), params: { diary: { content: @diary.content, theme: @diary.theme, title: @diary.title } }
